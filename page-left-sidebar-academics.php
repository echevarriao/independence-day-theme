<?php /* Template Name: Page -- Academics Left Side Menu & No Breadcrumbs*/ ?>
<?php get_header(); ?>
<?php if(is_front_page()){ ?>
<?php } elseif(is_active_sidebar('academics-section-bannerarea')){ ?>
<div id = "page-banner-bar" class = "long-row">
    <div class = "row">
        <div class = "large-12 custom-column">
    <?php dynamic_sidebar('academics-section-bannerarea'); ?>
        </div>
    </div>
</div>
<?php } else { ?>
