...
<meta http-equiv = "PRAGMA" content = "CACHE" />
	...
	<?php wp_head(); ?>
<meta name="msvalidate.01" content="E3B8E9B7AB324D7EE9E8780D8F5DF7AF" />
	</head>
<?php if(is_front_page()){ ?>
<body id = "frontpage" <?php body_class(); ?>>
<?php if (class_exists('Alert_Banner')) : Alert_Banner::show_alerts_in_content(); endif; ?>
<?php }else{ ?>
<body id = "secondarypage" <?php body_class(); ?>>
<?php if (class_exists('Alert_Banner')) : Alert_Banner::show_alerts_in_content(); endif; ?>
<?php } ?>
...
<?php endif; ?>
    ...
    <div class = "long-row" id = "header-bar" role = "banner"><!-- brand bar -->
        <div class = "row" id = "header-box">
            <div class = "large-6 columns left"><!-- brand box: uconn | university of connecticut  -->
                <ul id = "bannertop">
                    <li>
                        <div id = "uc-sig">
            ...
            <div class = "large-6 columns right"  id = "search-index-box"><!-- search/index box -->
				<ul id = "iconsbox">
                    <li>
                        <div>
                            <a href = "http://www.uconn.edu/search/"><img src = "https://www.engr.uconn.edu/wp-content/themes/engineering/images/m-icons_0000_search-white.png" alt = "image icon" /></a>
                        </div>
                    </li>
                    <li>
                        <div>
...
<div class = "long-row" id = "top-menu-bar">
	<div class = "row">
		<div class = "large-12">
<?php if(is_active_sidebar('menu-bar-area')): ?>
<?php dynamic_sidebar('menu-bar-area'); ?>
<?php else: ?>
...
<?php else: ?>
<?php if(is_active_sidebar('secondary-page-bannerarea')): ?>
...
<div class = "long-row" id = "top-menu-bar" role = "navigation">
	<div class = "row">
		<div class = "large-12">
<nav class="top-bar" data-topbar role="navigation">
  <ul class="title-area">
...
<?php endif; ?>
    <!-- content area -->
    <div class = "long-row" id = "body-box" role = "main">
<?php if(is_single() || is_archive()) { ?>
<?php if(is_active_sidebar('about-section-bannerarea')){ ?>
...
<div id = "page-title-bar" class = "long-row">
    <div class = "row">
        <div class = "large-12 column">
            ...
            Archives
            <?php elseif(is_post_type_archive('organization-event')): ?>
            Calendar
            <?php elseif(is_post_type_archive('academy-profile')): ?>
            Academy Member Profile(s)
            <?php elseif(is_tax()): ?>
            Keyword: <?php print single_cat_title( '', false ) ?>
            <?php else: ?>
            <?php the_title(); ?>
            <?php endif; ?>
            </h2>    
...
<?php } ?>
<div class = "row" id = "contentsection" role = "main">
