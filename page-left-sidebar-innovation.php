<?php /* Template Name: Page -- Innovation Left Side Menu & No Breadcrumbs*/ ?>
<?php get_header(); ?>
<?php if(is_front_page()){ ?>
<?php } elseif(is_active_sidebar('innovation-section-bannerarea')){ ?>
<div id = "page-banner-bar" class = "long-row">
    <div class = "row">
        <div class = "large-12 custom-column">
    <?php dynamic_sidebar('innovation-section-bannerarea'); ?>
        </div>
    </div>
</div>
<?php } else { ?>
...
<div class = "row" id = "contentsection">
    <div class = "large-12 column"><?php if(!is_front_page()): ?>
