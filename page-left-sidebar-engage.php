<?php /* Template Name: Page -- Engage Left Side Menu & No Breadcrumbs*/ ?>
<?php get_header(); ?>
<?php if(is_front_page()){ ?>
<?php } elseif(is_active_sidebar('engage-section-bannerarea')){ ?>
<div id = "page-banner-bar" class = "long-row">
    <div class = "row">
        <div class = "large-12 custom-column">
    <?php dynamic_sidebar('engage-section-bannerarea'); ?>
        </div>
    </div>
</div>
<?php } else { ?>
